...
- Các ghép layout động từ giao diện tĩnh có sẵn:
+ Chuyển toàn bộ tài nguyên của template: css, js, image, fonts ..
, copy vào thư mục assets của MVC
+ Copy nội dung file trang chủ của giao diện tĩnh vào file layout
của ứng dụng: copy mockup_html/backend/index.html ->main.php
+ Ktra lại toàn bộ đường dẫn tới các file css, js, image cho
đúng với đường dẫn của MVC
...
<!--main.php: Tích hợp CKEditor vào hệ thống: -->
<script src="assets/ckeditor/ckeditor.js"></script>
<script>
    //Code JS để tích hợp CKEditor vào trường mong muốn: chú ý
    //là CKEditor chỉ tích hợp đc vào textarea thông qua name
    //của textarea
